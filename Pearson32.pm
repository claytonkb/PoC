...
# This rand() is based on the Pearson hash. It is the hash of a hash of a hash. The hash is a 32-bit
# adaptation of Pearson's 8-bit hash.

#Test code:
#printf("%032b\n", time());
#
#$seed = pearson_rand32(time());
#for(1..20){
#    printf("%032b\n", $seed);
#    $seed = pearson_rand32($seed);
#}
