...
#
# Takes set-intersection of csvL.colX with csvR.colY and returns all
#   rows in csvA that land within the intersection; if only one column name X
#   provided, then Y is set to X

num_args = len(sys.argv) - 1

if(num_args < 3):
    print("Usage: python cm_intersect.py Lfile.csv Rfile.csv Lcol [Rcol]")
    sys.exit()
